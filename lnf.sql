...
--
-- Host: localhost:3306
-- Generation Time: Dec 03, 2017 at 09:46 PM
...
CREATE TABLE `item` (
  ...
  `category` set('bag','electronic','others','book') COLLATE utf8_general_mysql500_ci NOT NULL,
...
(1, 'humor', '', '59871-humor.png'),
(2, 'hi', '', '56367-health.jpg'),
(3, 'Food', '', '54411-serai.jpg'),
(4, 'Food2', '', '96389-budu.jpg'),
(5, 'Food3', '', '14625-belacan kering.jpg');
